"""
Django settings for sub360 project.
...
SECRET_KEY = "django-insecure-74^^!+2##3ys-a$ds*a3qvjuci3h#%jwkwn@x$6r#uu7t@jx96"
...
# LOGIN_REDIRECT_URL = ("authentication:user_detail")
